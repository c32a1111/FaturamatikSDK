...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "13.0"
  s.source = { 
    "http" => "https://github.com/c32a1111/FaturamatikSDK/releases/download/1.0.4/FaturamatikVerify.xcframework.zip",
    :sha256 => "0e8ac0caf19557431aab12be3ff67e4ee5d688dd69951c305a80273c3cabf9b7" 
  }
