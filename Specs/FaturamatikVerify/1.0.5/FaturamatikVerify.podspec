...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "13.0"
  s.source = { 
    "http" => "https://github.com/c32a1111/FaturamatikSDK/releases/download/1.0.5/FaturamatikVerify.xcframework.zip",
    :sha256 => "6188450b205a50018fc85f3fe31198d6c01afa5e9ef2556a032cc7527267a06f" 
  }
  s.source_files = "FaturamatikVerify/**/*.{h,m,swift,xib,mlpackage,mlmodel}"
  s.resources    = "FaturamatikVerify/**/Assets/**/*.*"
  s.resource_bundle = {
  'FaturamatikVerifyResources' => "FaturamatikVerify/Assets/**/*.*"
  }
