...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "13.0"
  s.source = { 
    "http" => "https://github.com/c32a1111/FaturamatikSDK/releases/download/1.0.6/FaturamatikVerify.xcframework.zip",
    :sha256 => "341fb9af94bfa7fc6968b626deeb90df7e4c6d2a20eded16a6f5c427d8b9c4c9" 
  }
