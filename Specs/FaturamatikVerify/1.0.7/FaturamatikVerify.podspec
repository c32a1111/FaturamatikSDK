...
Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "13.0"
  s.source = { 
    "http" => "https://github.com/c32a1111/FaturamatikSDK/releases/download/1.0.7/FaturamatikVerify.xcframework.zip",
    :sha256 => "1a0db1b5f7fb1f5c169040ff8dfdd41269328c204ae322e9a5a74ee5ad406814" 
  }
